...
- **Finish splitting the monolith into testable modules** - extract remaining settings/main-window composition and packaging/bootstrap code from `keepsync_notes.py` before adding larger sync or export features.
