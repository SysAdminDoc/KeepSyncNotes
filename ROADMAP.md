...
- **Finish splitting the monolith into testable modules** - extract remaining note editor and main-window composition from `keepsync_notes.py` before adding larger sync or export features.
